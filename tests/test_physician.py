...
class TestPhysician(TransactionCase):
    ...
    def test_schedule_generation_on_create(self):
        ...
        self.assertEqual(
            len(slots), 20, "Should generate 20 slots for a full day")
    ...
    def test_schedule_generation(self):
        ...
        self.assertEqual(
            len(slots), 20, "Should generate 20 slots for physician")
    ...
    def test_manual_schedule_generation(self):
        ...
        self.assertEqual(
            len(slots), 20, "Should generate 20 slots for the day")
